...
HD_PWD='/home/it/project_Lab/project_Lab.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adder4bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adder4bit.tcl -notrace
